  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-fade-in">
      <Button
        ...
        size="lg"
        className="rounded-full w-16 h-16 shadow-2xl hover:scale-110 transition-transform duration-300 p-0 backdrop-blur-sm bg-[#25D366] hover:bg-[#20bd5a] border-none"
        onClick={() => openWhatsApp("Hello Alerzen Health! I have a query regarding home collection.")}
